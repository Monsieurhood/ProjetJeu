//-----------------------------------------------------------------------
// <copyright file="PaletteTuiles.cs" company="Marco Lavoie">
...
namespace ProjetFinale
{
    ...
    /// Celles-ci peuvent servir soit à constituer un monde de tuiles (voir la classe MondeTuiles)
    /// ou les différents mouvements d'animation d'un sprite (voir classe SpriteAnimation).
    /// </summary>
    public class PaletteTuiles
    {
        /// <summary>
        /// Palette des tuiles.
        /// </summary>
        ...
        public PaletteTuiles(Texture2D tuiles, int largeurTuile, int hauteurTuile)
        {
            this.tuiles = tuiles;
