...
namespace ProjetFinale
{
    ...
    public interface IInputService
    {
        ...
        /// <summary>
        /// Retourne un entier entre 0.0 et 1.0 indiquant le facteur de vitesse à appliquer
        /// durant le jeu pour diriger le sprite du joueur vers le haut : 0.0 = aucun 
        /// déplacement, 1.0 = vitesse maximale.
        /// </summary>
        /// <param name="device">Le périphérique à lire.</param>
        /// <returns>Valeurs entre 0.0 (aucun mouvement) et 1.0 (vitesse maximale).</returns>
        float DeplacementHaut(int device);       // pour monter

        /// <summary>
        /// Retourne un entier entre 0.0 et 1.0 indiquant le facteur de vitesse à appliquer
        /// durant le jeu pour diriger le sprite du joueur vers le bas : 0.0 = aucun 
        /// déplacement, 1.0 = vitesse maximale.
        /// </summary>
        /// <param name="device">Le périphérique à lire.</param>
        /// <returns>Valeurs entre 0.0 (aucun mouvement) et 1.0 (vitesse maximale).</returns>
        float DeplacementBas(int device);     // pour descendre     
        ...
        /// <summary>
        /// Retourne un booléen indiquant si un Tire du personnage doit être effectue.
        /// </summary>
        /// <param name="device">Le périphérique à lire.</param>
        /// <returns>Vrai si le personnage doit Tirer; faux sinon.</returns>
        bool Tirer(int device);
