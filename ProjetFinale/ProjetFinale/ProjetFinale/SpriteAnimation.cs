    ...
    public abstract class SpriteAnimation : Sprite
    {
        ...
        public override Texture2D Texture
        {
            get
            {
                ...
                Texture2D tuile = new Texture2D(this.Palette.Tuiles.GraphicsDevice, this.Palette.LargeurTuile, this.Palette.HauteurTuile);

                // Extraire les pixels de la palette.
                Color[] donneesPalette = new Color[this.Palette.Tuiles.Width * this.Palette.Tuiles.Height];
                this.Palette.Tuiles.GetData<Color>(donneesPalette);
                ...
                Rectangle tuileRect = this.Palette.SourceRect(this.IndexTuile);
                ...
                for (int py = 0; py < tuile.Height; py++)
                {
                    ...
                    {
                        donneesTuile[px + (py * tuile.Width)] = donneesPalette[(tuileRect.X + px) + ((tuileRect.Y + py) * this.Palette.Tuiles.Width)];
                    }
                }
        ...
        {
            get { return this.Palette.LargeurTuile; }
        }
        ...
        {
            get { return this.Palette.HauteurTuile; }
        }
        ...
        public override void Update(GameTime gameTime, GraphicsDeviceManager graphics)
        {
            ...
            if (this.Palette.NombreDeTuiles != 0)
            {
                ...
                float indexSuivant = this.indexTuile + (vitesse * 0.01f * this.Palette.NombreDeTuiles);

                if (Math.Round(indexSuivant) < this.Palette.NombreDeTuiles)
                {
